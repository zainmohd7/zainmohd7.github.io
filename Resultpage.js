window.addEventListener("load",function()
{
    ...
    if(semnum==1 ){
        document.getElementById("result").innerHTML="TOTAL CGPA : "+resa;
        ...
        document.getElementById("result").innerHTML="TOTAL CGPA : "+sem2th.toFixed(2);
        ...
        document.getElementById("result").innerHTML="TOTAL CGPA : "+sem3th.toFixed(2);
        ...
        document.getElementById("result").innerHTML="TOTAL CGPA : "+sem4th.toFixed(2);
        ...
        document.getElementById("result").innerHTML="TOTAL CGPA : "+sem5th.toFixed(2);
        ...
        document.getElementById("result").innerHTML="TOTAL CGPA : "+sem6th.toFixed(2);
        ...
        document.getElementById("result").innerHTML="TOTAL CGPA : "+sem7th.toFixed(2);
        ...
        document.getElementById("result").innerHTML="TOTAL CGPA : "+sem8th.toFixed(2);
